...
public class Main {
    ...
    {
        //connects to the database named test with the root username and password
        String url = "jdbc:mysql://localhost:3306/test";
        String username = "Matthew";
        String password = "Mhchung523@";
        ...
        //takes the file input and just reads it and prints it out on a list
    ...
    //of passwords is less than 6, generates a new random password with a length of 6 in test
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                readFileData("C:\\Users\\matth\\IdeaProjects\\CISC191-FinalProjectTemplate\\Common\\src\\main\\java\\edu\\sdccd\\cisc191\\template\\users.txt");
            } else {
                sql = "CREATE TABLE users (id INT PRIMARY KEY AUTO_INCREMENT, username VARCHAR(50), password VARCHAR(50))";
...
class ConcurrentSort2D {
    ...
    //merges the two arrays passed in, then the list is sorted. It will use recursion to sort the array
